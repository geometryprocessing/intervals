...
int main(int argc, char *argv[])
{
    ...
    RUN_SPEED(extra_function4, "AUTO GENERATED RANDOM EXPRESSION 4", extra_function4_variable_count, extra_function4_range, check_input_extra_function4);
    RUN_SPEED(extra_function5, "AUTO GENERATED RANDOM EXPRESSION 5", extra_function5_variable_count, extra_function5_range, check_input_extra_function5);
    RUN_SPEED(extra_function6, "AUTO GENERATED RANDOM EXPRESSION 6", extra_function6_variable_count, extra_function6_range, check_input_extra_function6);
    RUN_SPEED(extra_function7, "AUTO GENERATED RANDOM EXPRESSION 7", extra_function7_variable_count, extra_function7_range, check_input_extra_function7);
    return 0;
}