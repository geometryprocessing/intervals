...
#define SPEED_TEST(METHOD, INFO, DISTRIBUTION, VARIABLE_COUNT)                                                                                                                                                            \
    ...
    {                                                                                                                                                                                                                     \
        ...
        printf("%lf, %lfx", our_time, our_time / fic_time);                                                                                                                                                               \
        printf("\n");                                                                                                                                                                                                     \
        printf("TIME, %s, BOOST METHOD, ", INFO);                                                                                                                                                                         \
        printf("%lf, %lfx", boost_time, boost_time / fic_time);                                                                                                                                                           \
        printf("\n");                                                                                                                                                                                                     \
        printf("TIME, %s, FILIB C, ", INFO);                                                                                                                                                                              \
        printf("%lf, %lfx", fic_time, fic_time / fic_time);                                                                                                                                                               \
        printf("\n");                                                                                                                                                                                                     \
        printf("TIME, %s, NATIVE SWITCHED, ", INFO);                                                                                                                                                                      \
        printf("%lf, %lfx", native_switched_time, native_switched_time / fic_time);                                                                                                                                       \
        printf("\n");                                                                                                                                                                                                     \
        printf("TIME, %s, MULTIPLICATIVE, ", INFO);                                                                                                                                                                       \
        printf("%lf, %lfx", multiplicative_time, multiplicative_time / fic_time);                                                                                                                                         \
        printf("\n");                                                                                                                                                                                                     \
        printf("TIME, %s, PRED SUCC, ", INFO);                                                                                                                                                                            \
        printf("%lf, %lfx", pred_succ_time, pred_succ_time / fic_time);                                                                                                                                                   \
        printf("\n");                                                                                                                                                                                                     \
    } while (0)
